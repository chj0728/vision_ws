...
/** Synchronizes RGB-D frames and publishes YOLO person detections with distance estimates. */
class TrtInferComponent : public rclcpp::Node {
public:
	explicit TrtInferComponent(const rclcpp::NodeOptions& options = rclcpp::NodeOptions());
